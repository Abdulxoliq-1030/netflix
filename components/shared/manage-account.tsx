                    ...
                    <li onClick={() => {
                        ...
                        <div className="relative">
                            <div className="max-w-[200px] rounded min-w-[84px] max-h-[200px] min-h-[84px] object-cover w-[155px] h-[155px] relative">
                                <Image src="https://occ-0-2611-3663.1.nflxso.net/dnm/api/v6/K6hjPJd6cR6FpVELC5Pd6ovHRSk/AAAABfNXUMVXGhnCZwPI1SghnGpmUgqS_J-owMff-jig42xPF7vozQS1ge5xTgPTzH7ttfNYQXnsYs4vrMBaadh4E6RTJMVepojWqOXx.png?r=1d4"
                                    alt='account'
                                    fill />
                            </div>
                            {isDelete ? (
                        ...
                        <div className='flex items-center gap-1'>
                            <span className='font-mono font-bold text-xl'>Abdulxoliq</span>
                            <LockKeyhole />
                        </div>
                    </li>
                    <li onClick={() => {
